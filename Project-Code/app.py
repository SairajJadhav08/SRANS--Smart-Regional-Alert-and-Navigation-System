...
def _init_db():
    ...
    if User.query.count() == 0:
        ...
        sample_alerts = [
            Alert(title='Highway 101 Closure',  # type: ignore
            ...
            Alert(title='Flash Flood Warning',  # type: ignore
                  ...
                  author_id=admin_user.id),
            Alert(title='Bridge Repair',  # type: ignore
                  ...
                  author_id=admin_user.id),
            Alert(title='Heavy Rain Warning',  # type: ignore
